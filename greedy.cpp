...
void printGreedy(int coins[], int denominationsSize, int numCoins, int results[], char *fileName){
	string outputString(fileName);
	outputString.erase(outputString.find_last_of("."), string::npos);
	string filename2 = "./" + outputString + "change.txt";
	ofstream myfile2;
    ...
    if(myfile)
    {
        ...
        while(getline(myfile,line))
        {
            ...
            while(1) {
	            ...
	            printGreedy(coins, denominationsSize, numCoins, results, argv[1]);
